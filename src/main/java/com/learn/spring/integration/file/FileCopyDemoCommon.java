...
public class FileCopyDemoCommon {
	...
	public static final Logger LOGGER = LoggerFactory.getLogger(FileCopyDemoCommon.class);
	...
	public static void displayDirectories(ApplicationContext context) {
		...
		LiteralExpression expression = (LiteralExpression) new DirectFieldAccessor(context.getBean(FileWritingMessageHandler.class))
